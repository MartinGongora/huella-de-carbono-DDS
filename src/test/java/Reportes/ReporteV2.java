...
public class ReporteV2 {
  ...
  GeneradorDeReportesV2 reportero;
  ...
  public void init() throws IOException {
    ...
    reportero = new GeneradorDeReportesV2();
  ...
  public void reporteSectorTerritorialCaba() throws IOException{
   ...
   // System.out.println(reporteOrganizacion.getHcPorSector());
    ...
    Assert.assertEquals(sectorTerritorialCaba, reporteEvolucionSectorTerritorial.getSector());
