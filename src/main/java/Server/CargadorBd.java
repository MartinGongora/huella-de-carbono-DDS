...
public class CargadorBd {
  ...
  public void run() {
    ...
    try {
      ...
      Provincia buenosAires = new Provincia("Buenos Aires", 1);
      Provincia CABA = new Provincia("Ciudad Autonoma de Buenos Aires", 2);
      Provincia catamarca = new Provincia("Catamarca", 3);
      Provincia chaco = new Provincia("Chaco", 4);
      Provincia chubut = new Provincia("Chubut", 5);
      Provincia cordoba = new Provincia("Cordoba", 6);
      Provincia corrientes = new Provincia("Corrientes", 7);
      Provincia entreRios = new Provincia("Entre Rios", 8);
      Provincia formosa = new Provincia("Formosa", 9);
      Provincia jujuy = new Provincia("Jujuy", 10);
      Provincia laPampa = new Provincia("La Pampa", 11);
      Provincia laRioja = new Provincia("La Rioja", 12);
      Provincia mendoza = new Provincia("Mendoza", 13);
      Provincia misiones = new Provincia("Misiones", 14);
      Provincia neuquen = new Provincia("Neuquen", 15);
      Provincia rioNegro = new Provincia("Rio Negro", 16);
      Provincia salta = new Provincia("Salta", 17);
      Provincia sanJuan = new Provincia("San Juan", 18);
      Provincia sanLuis = new Provincia("San Luis", 19);
      Provincia santaCruz = new Provincia("Santa Cruz", 20);
      Provincia santaFe = new Provincia("Santa Fe", 21);
      Provincia santiagoDelEstero = new Provincia("Santiago del Estero", 22);
      Provincia tierraDelFuego = new Provincia("Tierra del Fuego", 23);
      Provincia tucuman = new Provincia("Tucuman", 24);
      ...
      */
      ...
      //ubicacion
      Municipio haedo = new Municipio("Haedo",4, 40);
      ...
      //ubicaciones
      Municipio balbanera = new Municipio("Balbanera",4, 41);
      ...
      Municipio merlo = new Municipio("Merlo",5, 42);
